...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку для оформления заказа, телефон: ' . $tel . ' , детали заказа: ' . $details;

    // Первый параметр - кому отправляем письмо, второй - тема письма, третий - содержание
    $success = mail("admin@florarium.com ", 'Данные для оформления заказа', $content);
